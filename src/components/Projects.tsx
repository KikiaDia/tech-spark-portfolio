...
const projects = {
  en: [
    ...
    {
      title: "PageRank Implementation and Performance Comparison with PySpark on GCP",
  ...
  fr: [
    ...
    {
      title: "Implémentation et Comparaison des Performances de PageRank avec PySpark sur GCP",
