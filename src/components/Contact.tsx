        ...
        >
          <div>
            <input
              ...
              className="w-full p-3 rounded-lg border border-[#e5e7eb] focus:outline-none focus:ring-0 focus:border-[#e5e7eb] text-black placeholder-black"
              required
            />
          </div>
          ...
          <div>
            <textarea
              ...
              rows={6}
              className="w-full p-3 rounded-lg border border-[#e5e7eb] focus:outline-none focus:ring-0 focus:border-[#e5e7eb] resize-none text-black placeholder-black"
              required
            />
          </div>
